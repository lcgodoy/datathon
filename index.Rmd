...
- Sempre que possível utilizar API's, por serem estáveis
e bem documentadas;
- Quando estiverem baixando dados de algum repositório
público, verificar se as URL's não seguem um padrão
lógico de modo que o processo posso ser automatizado pelo Rç
- Web Scraping é uma boa alternativa apenas quando estas
duas últimas opções não estão disponíveis.
